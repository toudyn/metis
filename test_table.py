...
def test_table_creation():
    ...
    t = Table('test_table', table_tasks)
    assert t

def test_table_tasks_create_properly():
...
def test_get_current_requirement_unstarted():
    ...
    t = Table('test_table', table_tasks)
    assert t.get_current_task_requirement() == ('analysis', 'analyst', 7)
...
def test_get_current_requirement_started():
    ...
    t.set_assigned()
    t.record_work_done()
    assert t.get_current_task_requirement() == ('analysis', 'analyst', 6)
...
def test_get_current_requirement_second_task():
    ...
    for i in range(7):
        t.record_work_done() # Complete analysis
    assert t.get_current_task_requirement() == ('build', 'developer', 5)
...
def test_get_current_requirement_completed():
    ...
    for i in range(5):
        t.record_work_done() # Complete test
    assert t.get_current_task_requirement() == (None , None, 0)
